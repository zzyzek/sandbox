...
//UNTESTED!!
function intersect_capsule_capsule(p0, q0, r0, p1, q1, r1, cs_pt0, cs_pt1) {
  let dist = closest_segment(p0,q0, p1,q1, cs_pt0, cs_pt1);
  if (dist <= (r0+r1)) { return 1; }
  return 0;
}

//UNTESTED!!
function intersect_segment_capsule(p0,q0, p1, q1, r, isc_pt0, isc_pt1) {
  let dist = closest_segment(p0,q0,p1,q1, u0, isc_pt0, isc_pt1);
  if (dist <= r) { return 1; }
  return 0;
}
