...
| `001` |  $P_1$  | $\gamma_{2e}, \alpha_{2e}, \beta_{2e}$ | $\beta, \gamma_{2 * }, \alpha_{2e}$ | $\alpha, -\beta_{2 * }, -\gamma_{2 * }$ | $\beta, \gamma_{2 * }, -\beta_{2 * }$ | $-\gamma_{2 e}, \alpha_{2 * }, \beta{2e}$ |
...
| `011` |  $P_1$  | $\gamma_{2e}, \alpha_{2e}, \beta_{2e}$ | $\beta, \gamma_{2 * }, \alpha_{2e}$ | $\alpha, -\beta_{2 * }, -\gamma_{2 * }$ | $\beta, \gamma_{2 * }, -\beta_{2 * }$ | $-\gamma_{2 e}, \alpha_{2 * }, \beta{2e}$ |
...
| `101` |  $P_1$  | $\gamma_{2e}, \alpha_{2e}, \beta_{2e}$ | $\beta, \gamma_{2 * }, \alpha_{2e}$ | $\alpha, -\beta_{2 * }, -\gamma_{2 * }$ | $\beta, \gamma_{2 * }, -\beta_{2 * }$ | $-\gamma_{2 e}, \alpha_{2 * }, \beta{2e}$ |
